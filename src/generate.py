...
if len(sys.argv) > 1 and sys.argv[1] == "--llvm":
    ...
    os.system(CLANG_COMPILE_PREFIX+"./generation/libsysy/libsysy.c -o ./out/llvm/lib.ll -O0 2> ./out/llvm/answer.err")
    # for answer
    os.system(CLANG_COMPILE_PREFIX+"./generation/testfile.c -o ./out/llvm/origin.ll -O0 2>> ./out/llvm/answer.err")
    ...
    # clean
    os.system("rm ./out/llvm/lib.ll ./out/llvm/origin.ll ./out/llvm/testfile_origin.ll ./llvm_ir.txt ./mips.txt")
elif len(sys.argv) > 1 and sys.argv[1] == "--mips":
    # init
    os.system("cat ./testfile.txt > ./generation/testfile.c")
    os.system(CLANG_COMPILE_PREFIX+"./generation/libsysy/libsysy.c -o ./out/mips/lib.ll -O0 2> ./out/mips/answer.err")
    # for answer
    os.system(CLANG_COMPILE_PREFIX+"./generation/testfile.c -o ./out/mips/origin.ll -O0 2>> ./out/mips/answer.err")
