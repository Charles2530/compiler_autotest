...
if len(sys.argv) > 1 and sys.argv[1] == "--llvm":
    ...
    # clean
    os.system(
        "rm ./out/llvm/lib.ll ./out/llvm/origin.ll ./out/llvm/testfile_origin.ll ./llvm_ir.txt ./mips.txt")
    ...
    os.system(
        "cat ./InstructionStatistics.txt > ./out/mips/InstructionStatistics.txt")
    # clean
    os.system(
        "rm ./mips.txt ./llvm_ir.txt ./out/mips/lib.ll ./out/mips/origin.ll ./InstructionStatistics.txt")
else:
