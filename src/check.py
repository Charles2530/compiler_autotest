...
if len(sys.argv) > 1 and sys.argv[1] == "--llvm":
            ...
            while True:
                ...
                if answer == testfile:
                    ...
                    ColorfulPrint.colorfulPrint(
                        "===== WA in line: "+str(line)+" =====", ColorfulPrint.MODE_BOLD, ColorfulPrint.COLOR_RED)
                    ColorfulPrint.colorfulPrint(
                        "answer:"+str(answer), ColorfulPrint.MODE_BOLD, ColorfulPrint.COLOR_YELLOW)
                    ColorfulPrint.colorfulPrint(
                        "testfile:"+str(testfile), ColorfulPrint.MODE_BOLD, ColorfulPrint.COLOR_YELLOW)
                    sys.exit(1)
    with open("./out/llvm/answer_return.out", "r") as f:
        with open("./out/llvm/testfile_return.out", "r") as g:
            ...
            if (answer == testfile):
                ColorfulPrint.colorfulPrint(
                    '===== Accepted =====', ColorfulPrint.MODE_BOLD, ColorfulPrint.COLOR_BLUE)
            else:
                ColorfulPrint.colorfulPrint(
                    '===== WA in return value =====', ColorfulPrint.MODE_BOLD, ColorfulPrint.COLOR_RED)
                ColorfulPrint.colorfulPrint(
                    "answer:"+str(answer), ColorfulPrint.MODE_BOLD, ColorfulPrint.COLOR_YELLOW)
                ColorfulPrint.colorfulPrint(
                    "testfile:"+str(testfile), ColorfulPrint.MODE_BOLD, ColorfulPrint.COLOR_YELLOW)
